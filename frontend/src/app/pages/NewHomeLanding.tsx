      ...
      <main className="hero-container">
        ...
        <motion.section className="hero-content" variants={staggerContainer} initial="initial" whileInView="visible" viewport={viewportOptions}>
          ...
          <motion.div className="cta-wrapper" variants={slideUpVariant}>
            ...
            <div className="demo-group mt-4 relative flex justify-center min-h-[46px]">
              <button 
                className={`transition-all duration-[500ms] ease-out group rounded-full p-[2px] overflow-hidden hover:scale-105 active:scale-95 ${
                  isScrolled 
                    ? 'fixed bottom-8 right-8 z-[9999] shadow-2xl scale-110' 
              ...
              >
                ...
                <div 
                  className="absolute inset-[-100%] animate-spin [animation-duration:4s]" 
                  style={{
                    background: 'conic-gradient(from 0deg, #00d2ff, #00e676, #ffea00, #00e676, #00d2ff)'
                  }}
                />
                
                {/* Inner White Pill */}
                <div className="relative bg-white rounded-full px-6 py-[10px] flex items-center justify-center gap-2 h-full w-full">
                  <svg width="18" height="18" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#2a2b2c]">
                    <path d="M26 14 C 26 21, 31 24, 36 24 C 31 24, 26 27, 26 34 C 26 27, 21 24, 16 24 C 21 24, 26 21, 26 14 Z" fill="currentColor"/>
                    <path d="M14 8 C 14 12.5, 17.5 14, 20 14 C 17.5 14, 14 15.5, 14 20 C 14 15.5, 10.5 14, 8 14 C 10.5 14, 14 12.5, 14 8 Z" fill="currentColor"/>
                    <path d="M12 28 C 12 31, 14.5 32, 16 32 C 14.5 32, 12 33, 12 36 C 12 33, 9.5 32, 8 32 C 9.5 32, 12 31, 12 28 Z" fill="currentColor"/>
                  </svg>
                  <span className="text-[14px] font-semibold text-[#2a2b2c] tracking-wide pr-1">AI</span>
                </div>
              </button>
            </div>
          </motion.div>
